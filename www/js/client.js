...
let swalBackground = '#e7fadf'; // black - #16171b - transparent ...
let peerGeo;
let peerConnection;
let myPeerName;
let useAudio = true;
...
function welcomeUser() {
    ...
    Swal.fire({
        ...
        // imageAlt: 'Welcome To Jupyter Meet',
        imageUrl:  'Welcome To Jupyter Meet',
        html:
            `
        <br/> 
        ...
        if (result.isConfirmed) {
            ...
            let message = {
                email: '',
                subject: 'Please join our Jupyter Meet Video Chat Meeting',
...
function setTheme(theme) {
    ...
    switch (mirotalkTheme) {
        case 'neon':
            ...
            document.documentElement.style.setProperty('--body-bg', '#e7fadf');
            document.documentElement.style.setProperty('--msger-bg', '#e7fadf');
            document.documentElement.style.setProperty('--msger-private-bg', '#e7fadf');
            document.documentElement.style.setProperty('--left-msg-bg', '#1e2c84');
            document.documentElement.style.setProperty('--private-msg-bg', '#f77070');
            document.documentElement.style.setProperty('--right-msg-bg', '#1e2c84');
            document.documentElement.style.setProperty('--wb-bg', '#e7fadf');
            document.documentElement.style.setProperty('--wb-hbg', '#e7fadf');
        ...
        case 'sky':
            ...
            document.documentElement.style.setProperty('--wb-hbg', '#e7fadf');
            document.documentElement.style.setProperty('--btn-bg', 'white');
            document.documentElement.style.setProperty('--btn-color', '#e7fadf');
            document.documentElement.style.setProperty('--btn-opc', '1');
            document.documentElement.style.setProperty('--btns-left', '20px');
